...
import xyz.totok.util.constant.Charsets;
...
public final class IOUtils {
     ...
     * @param length length to read, must be greater or equal 0
     ...
     * @param buffer destination
     * @param offset inital offset into buffer
     * @param length length to read, must be greater than or equal to 0
     * @throws IOException              if there is a problem reading the file
     * @throws IllegalArgumentException if length is negative
     ...
     * @param stream
     * @return boolean
     * @see IOUtils#writeStream(String, InputStream)
     */
     ...
     * @param stream
     * @return boolean
     * @see IOUtils#writeStream(File, InputStream)
     */
